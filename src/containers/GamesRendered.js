      ...
      <div className="games-rendered">
        <div className="col">
          <div className="game-item">
            <div className="background" style={{backgroundImage: 'url("https://media.rawg.io/media/crop/600/400/games/84d/84da2ac3fdfc6507807a1808595afb12.jpg")'}}>
            ...
            <div className="game-item__info">
              <div className="game-item__info__top">
                ...
                <span className="game-item__meta -metacritic-green">97</span>
              </div>
              <div className="game-item__info__bottom">
                <a title="Grand Theft Auto V" className="heading-1 game-item__name" href="#/games/grand-theft-auto-v" style={{textDecoration: 'none'}}>Grand Theft Auto V</a>
                <svg stroke="currentColor" fill="currentColor" strokeWidth={0} viewBox="0 0 1024 1024" className="icon icon--like" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
